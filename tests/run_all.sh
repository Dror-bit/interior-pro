...
for f in plan_editor.rb plan_generator.rb door_library.rb door_tool.rb room_manager.rb ceiling_manager.rb level_manager.rb molding_tool.rb wall_tool.rb foundation_manager.rb ui_dialogs.rb wall_stretch_tool.rb floor_manager.rb roof_manager.rb roof_dialog.rb arc_math.rb; do
  [ -f "$SRC/$f" ] && cp "$SRC/$f" . || echo "  (missing $f - some suites will be skipped)"
done

echo "== ruby syntax =="
fail=0
for f in plan_editor.rb plan_generator.rb door_library.rb door_tool.rb arc_math.rb; do
  [ -f "$f" ] || continue
...
for t in t1 t2 t3 t4 t5 t6 t7 t8 t9 t12 t13 t14 t15 t16 t17 t18 t19 t20 t21 t22 t23 t24 t25 t26 t27 t28 t29 t30 t31 t32; do
  [ -f "$t.js" ] || continue
...
for r in rt rt2 rt3 rt4 rt5 rt6 rt7 rt8 rt9 rt10 rt11 rt12 rt13 rt14 rt15 rt16 rt17 rt18 rt19 rt20; do
  [ -f "$r.rb" ] || continue
