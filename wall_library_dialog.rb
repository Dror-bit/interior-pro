      ...
      <<~HTML
        ...
        <div class="content">
          ...
          <div class="form-panel" id="formPanel">
            ...
            <div class="row" id="exteriorFields">
              <div>
              ...
              <div>
                ...
                <input type="color" id="intColor" value="#ffffff" style="width:100%; height:36px; padding:2px; border:1px solid #ccc; border-radius:4px;">
              </div>
            </div>
            <div class="row" id="interiorFields" style="display:none;">
              <div>
        ...
        <script>
          ...
          window.onload = function() {
            ...
            document.getElementById('wallCategory').addEventListener('change', toggleCategoryFields);
            toggleCategoryFields();
          };

          function toggleCategoryFields() {
            var cat = document.getElementById('wallCategory').value;
