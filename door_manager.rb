...
module InteriorPro
  module DoorManager
    ...
    # Translate door/window bodies hosted on a wall after the wall itself moved.
    # (Restored from git c4fe86e~1 — was deleted on 2026-07-02 while the call in
    # ui_dialogs.rb wall_move remained.)
